...
public abstract class DmdataGateway implements Gateway<DmdataEEW> {
    ...
    public void run() {
        try {
            ...
            if (multiConnect) {
                this.webSocket1 = connectWebSocket(WS_BASE_TOKYO, this.appName + "-1", hasForecastContract, openSocketList());
                this.webSocket2 = connectWebSocket(WS_BASE_OSAKA, this.appName + "-2", hasForecastContract, openSocketList());
            } else {
                this.webSocket1 = connectWebSocket(WS_BASE, this.appName + "-1", hasForecastContract, openSocketList());
            }
