...
class VXSE51WebhookTest {
    ...
    void testDiscordWebhookJson_case1() throws IOException, JSONException {
        testXmlToDiscordWebhook("jmaxml/vxse51/case1.xml", "jmaxml/vxse51/case1_discord_expected.json");
    }

    @Test
    void testDiscordWebhookJson_case2() throws IOException, JSONException {
        testXmlToDiscordWebhook("jmaxml/vxse51/case2.xml", "jmaxml/vxse51/case2_discord_expected.json");
    }

    @Test
    void testExternalWebhookJson_case1() throws IOException, JSONException {
        testXmlToExternalWebhook("jmaxml/vxse51/case1.xml", "jmaxml/vxse51/case1_external_expected.json");
    }

    @Test
    void testExternalWebhookJson_case2() throws IOException, JSONException {
        testXmlToExternalWebhook("jmaxml/vxse51/case2.xml", "jmaxml/vxse51/case2_external_expected.json");
    }
